...
export function SubscriptionDetailsCard({subscriptionContract}: Props) {
  ...
  return (
    <Card>
      <BlockStack gap="400">
        ...
        <BlockStack gap="200">
          {lines.map((line) => {
            return <SubscriptionLineItem key={line.id} line={line} />;
          })}
        </BlockStack>
        <Divider />
        <BlockStack>
          {discountText ? (
            <Grid columns={{xs: 3, sm: 3, md: 4, lg: 5, xl: 5}}>
