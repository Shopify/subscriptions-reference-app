...
export function ProductPickerCard({
  ...
  const {error: selectedProductsError} = useField('selectedProductIds');
  const {error: selectedVariantsError} = useField('selectedVariantIds');
  ...
  async function selectProducts(selectedProducts: any[], searchQuery?: string) {
