...
import {useAddressFormSettings} from '../../hooks/useAddressFormSettings';
...
export function AddressModal({
  ...
  const {data: addressFormData, loading: addressFormSettingsLoading} =
    useAddressFormSettings({skip: !addressModalOpen});
  ...
  const showSkeleton = countriesLoading || addressFormSettingsLoading;
          ...
          {orderedFields.map((line, index) => {
            return (
              <AddressLine
                ...
                addressFormSettings={addressFormData?.shop.addressFormSettings}
                disabled={loading}
              />
            );
          })}
