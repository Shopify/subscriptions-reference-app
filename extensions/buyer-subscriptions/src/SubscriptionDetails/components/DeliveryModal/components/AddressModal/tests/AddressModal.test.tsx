...
import * as useAddressFormSettings from '../../../hooks/useAddressFormSettings';
...
describe('<AddressModal />', () => {
  ...
  describe('loading state', () => {
    ...
    it('renders skeleton text while the address form settings are loading', async () => {
      vi.spyOn(
        useAddressFormSettings,
        'useAddressFormSettings',
      ).mockImplementation(() => ({
        data: undefined,
        loading: true,
