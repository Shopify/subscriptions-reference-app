...
import type {AddressFormSettings} from '../../hooks/useAddressFormSettings';
    ...
    .map((field) => {
      switch (field) {
        case FieldName.FirstName:
          return addressFormSettings?.firstName.mode === 'IGNORED' ? null : (
            <TextField
              key={field}
        ...
        case FieldName.Address2:
          return addressFormSettings?.address2.mode === 'IGNORED' ? null : (
            <TextField
              key={field}
        ...
        case FieldName.Phone:
          return addressFormSettings?.phone.mode === 'IGNORED' ? null : (
            <PhoneField
              key={field}
